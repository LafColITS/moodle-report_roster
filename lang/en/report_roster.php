...
$string['settings:displayname:help'] = 'This will display on the report page and in the flat navigation link (if enabled below).';
$string['settings:displayname:default'] = 'Roster';
$string['settings:fields'] = 'Profile fields to display';
$string['settings:fields:help'] = 'A list of profile fields to display in the report. Each field identifier should be on a new line. \'fullname\' is also supported.
...
$string['settings:flatnav:help'] = 'If checked, a link to the Roster report will be added to the Boost flat navigation.
...
$string['settings:flatnav_position:help'] = 'A link to the report will be added *above* the link at the top of this list.
...
$string['settings:size_default:help'] = 'Default user image size (when a user first opens the report).';
$string['settings:size_large'] = 'Size: Large';
$string['settings:size_large:help'] = 'User image size in pixels for "Large"';
$string['settings:size_medium'] = 'Size: Medium';
$string['settings:size_medium:help'] = 'User image size in pixels for "Medium"';
$string['settings:size_small'] = 'Size: Small';
$string['settings:size_small:help'] = 'User image size in pixels for "Small"';
